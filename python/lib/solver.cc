  ...
  steady_state_solver.def(
    ...
    dict
        ...
        - ``csda_particle_relative_balance``:
          Optional absolute CSDA particle balance divided by
          ``abs(production_rate + inflow_rate)``.
        ...
        - ``csda_energy_relative_balance``:
          Optional absolute CSDA energy balance divided by
          ``abs(csda_energy_production_rate + csda_energy_inflow_rate)``.
