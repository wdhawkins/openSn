...
private:
  ...
  /// Applies a fully validated local density vector and refreshes GPU carriers if needed.
...
public:
  ...
  static InputParameters GetDensityBlock();
  static InputParameters GetDensityByBlockEntryBlock();
};
