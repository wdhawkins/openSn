...
"""
2D 2G CBC k-eigenvalue test using Power Iteration with UDSA.
"""
...
if __name__ == "__main__":
    ...
    if rank == 0:
        print(f"qblock_cbc_unaccelerated_k: {unaccelerated_k:.7f}")
        print(f"qblock_cbc_unaccelerated_iterations: {unaccelerated_iterations}")
        print(f"qblock_cbc_udsa_k: {udsa_k:.7f}")
        print(f"qblock_cbc_udsa_iterations: {udsa_iterations}")
        print(
            "qblock_cbc_udsa_iteration_reduction: "
