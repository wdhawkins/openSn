...
"""
3D Transport test with multiple groupsets, groupset-to-groupset upscattering, and UDSA
SDM: PWLD
"""
...
def effective_iteration_count(problem):
    ...
    return max(problem.GetWGSSolveSummary(gsid)["num_iterations"] for gsid in range(3))
