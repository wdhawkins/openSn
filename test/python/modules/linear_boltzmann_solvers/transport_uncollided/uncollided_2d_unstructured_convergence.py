...
def compute_error(mesh_name, file_name):
    ...
    # Fixed physical size across resolutions. For coarse meshes, this may
    # include most/all cells on the mesh. This is expected, but only the finest
    # mesh's error is what matters.
